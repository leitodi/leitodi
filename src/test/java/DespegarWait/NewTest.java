...
public class NewTest {
	  ...
	  @Test(dataProvider= "diferentesdestinos",description = "Validar botones seleccion")
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("div.sbox5-box-dates-checkbox-container div.sbox5-dates-input1")));
		elegir.click();	
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("div.sbox5-floating-tooltip-opened div.calendar-footer em.btn-text")));
		aplicar.click();		
		//seleccion pasajeros
